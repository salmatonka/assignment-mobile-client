  ...
  const handleAdvertising = (id) => {
    ...
    return (
        ...
        <td>
          {
            advertising ?
            <button disabled className="btn bg-red-300 btn-md">Advertising</button>
            :
            <button onClick={()=> handleAdvertising(_id)} className="btn bg-red-300 btn-md">Advertising</button>
